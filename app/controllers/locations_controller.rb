...
def update
  ...
  address = "#{params[:lat]}, #{params[:lng]}"
  coordinates = Geocoder.coordinates(address)
  @location.assign_attributes(name: location.name, place_id: location.place_id, lat: location.lat, lng: location.lng, icon: location.icon lat: location.lat, lng: location.lng)
  @location.save
