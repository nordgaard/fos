  ...
  task :pull_data => :environment do
    ...
    p @client
    locations = @client.spots(37.756378, -122.416445,:types => [ 'bar', 'night_club', 'liquor_store'], :exclude => ['restaurant', 'food', 'cafe', 'bakery', 'meal-takeaway', 'meal-delivery', 'grocery-or-supermarket', 'gas-station', 'convenience_store'])
